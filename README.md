...
- Можно включить в настройках функцию "Начать диалог первым", тем самым ИИ может начать с пользователем диалог, например при интенсивной работе предложить помощь(для работы необходим модуль vision)
